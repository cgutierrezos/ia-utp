<?php $__env->startSection('title', 'Algoritmos'); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <div id="page-wrapper">
        ...
        <?php echo $__env->make('templates.banner_welcome', [
            ...
            'atitle' => 'siguiente'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <!-- One -->
        <?php echo $__env->make('templates.spotlight_bottom', [
        ...
        <!-- Two -->
        <?php echo $__env->make('templates.spotlight_right', [
        ...
        <?php echo $__env->make('templates.spotlight_left',[
