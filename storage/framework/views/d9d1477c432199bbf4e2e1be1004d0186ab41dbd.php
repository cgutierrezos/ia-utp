...
<?php $__env->startSection('body'); ?>
	...
	<script src="<?php echo e(asset('js/arbor-tween.js')); ?>"></script>
	<script src="<?php echo e(asset('js/arbor.js')); ?>"></script>
	<script src="<?php echo e(asset('js/graphics.js')); ?>"></script>
	<script src="<?php echo e(asset('js/renderer.js')); ?>"></script>
	<script src="<?php echo e(asset('js/node.js')); ?>"></script>
	<script src="<?php echo e(asset('js/anodes.js')); ?>"></script>
	<script src="<?php echo e(asset('js/tree_generate.js')); ?>"></script>
	<script src="<?php echo e(asset('js/blind_search.js')); ?>"></script>
	<script src="<?php echo e(asset('js/tree_animation.js')); ?>"></script>
