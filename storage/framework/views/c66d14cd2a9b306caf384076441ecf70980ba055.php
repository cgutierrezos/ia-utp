<?php $__env->startSection('title', 'animacion'); ?>

<?php $__env->startSection('body'); ?>

	<script src="<?php echo e(asset('js/jquery.min.js')); ?>"></script>
	<script src="<?php echo e(asset('plugins/vis/dist/vis.js')); ?>"></script>
	<script src="<?php echo e(asset('plugins/vis/examples/googleAnalytics.js')); ?>"></script>
	<script src="<?php echo e(asset('js/node.js')); ?>"></script>
	<script src="<?php echo e(asset('js/edge.js')); ?>"></script>
	<script src="<?php echo e(asset('js/grafo.js')); ?>"></script>
	<script src="<?php echo e(asset('js/busqueda_ciega.js')); ?>"></script>
	<script src="<?php echo e(asset('js/busqueda_guiada.js')); ?>"></script>
	<script src="<?php echo e(asset('js/grafo_animacion.js')); ?>"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('plugins/vis/dist/vis.css')); ?>">
	...
	<?php echo $__env->make('templates.banner_animation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
